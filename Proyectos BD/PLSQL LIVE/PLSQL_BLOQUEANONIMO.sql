...
DECLARE
    -- Declaración de constantes, variables y excepciones
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            DBMS_OUTPUT.PUT_LINE('El resultado de la función es: ' || V_RESULTADO_FNC);

            IF V_RESULTADO_FNC IS NOT NULL
               OR V_RESULTADO_FNC = 0 THEN
                DBMS_OUTPUT.PUT_LINE('El resultado no es nulo');
            ELSE
                DBMS_OUTPUT.PUT_LINE('El resultado es nulo');
            END IF;
        END;
    END;
